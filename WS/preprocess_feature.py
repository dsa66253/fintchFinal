...
class DataOrganizer(object):
    ...
    def _normalize_drop_txn(self, txn_df):
        ...
        triple_idx_df.drop(['MARKET_TYPE_CODE'],1,inplace=True)
        triple_idx_df = triple_idx_df.dropna()
    ...
    def _normalize_drop_cust(self, cust_df):
        ...
        triple_idx_df.drop(['SOURCE_CODE', 'BREACH_IND', 'BREACH_RANK'],1,inplace=True)
        triple_idx_df = triple_idx_df.dropna()
    ...
    def organize_data(self):
        ...
        model.fit(cust_idx_df.values, cust_idx_df.BREACH_DATE_RANK.values)
